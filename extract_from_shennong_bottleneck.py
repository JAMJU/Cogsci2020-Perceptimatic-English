...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='script to extract multilingual bottleneck features')
    parser.add_argument('folder_in', metavar='f_do', type=str,
                        help='folder where the wavs are')
    parser.add_argument('folder_out', metavar='f_do', type=str,
                        help='folder where to put the output')
    parser.add_argument('type_net', metavar='f_do', type=str,
